...
pkgdatadir = $(datadir)/pan
pkgincludedir = $(includedir)/pan
pkglibdir = $(libdir)/pan
pkglibexecdir = $(libexecdir)/pan
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/README.windows.in \
	$(srcdir)/config.h.in $(srcdir)/pan.iss.in \
	$(srcdir)/pan.spec.in $(top_srcdir)/configure AUTHORS COPYING \
...
CONFIG_CLEAN_FILES = pan.spec pan.iss README.windows
...
am__installdirs = "$(DESTDIR)$(Productivitydir)" \
	"$(DESTDIR)$(icondir)"
...
ACLOCAL = ${SHELL} /home/herald/workspace/pan-0.139/missing --run aclocal-1.11
ALL_LINGUAS = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /home/herald/workspace/pan-0.139/missing --run autoconf
AUTOHEADER = ${SHELL} /home/herald/workspace/pan-0.139/missing --run autoheader
AUTOMAKE = ${SHELL} /home/herald/workspace/pan-0.139/missing --run automake-1.11
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
GMIME_CFLAGS = -pthread -D_LARGEFILE64_SOURCE -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/gmime-2.6  
GMIME_LIBS = -lgmime-2.6 -lgio-2.0 -lgobject-2.0 -lglib-2.0  
GMIME_REQUIRED = 
GMOFILES = 
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/herald/workspace/pan-0.139/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
PACKAGE_NAME = Pan
PACKAGE_STRING = Pan 0.139
PACKAGE_TARNAME = pan
PACKAGE_URL = http://pan.rebelbase.com/
PACKAGE_VERSION = 0.139
PATH_SEPARATOR = :
...
abs_builddir = /home/herald/workspace/pan-0.139
abs_srcdir = /home/herald/workspace/pan-0.139
abs_top_builddir = /home/herald/workspace/pan-0.139
abs_top_srcdir = /home/herald/workspace/pan-0.139
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/herald/workspace/pan-0.139/install-sh
...
pan.spec: $(top_builddir)/config.status $(srcdir)/pan.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pan.iss: $(top_builddir)/config.status $(srcdir)/pan.iss.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
install-ProductivityDATA: $(Productivity_DATA)
	...
	@list='$(Productivity_DATA)'; test -n "$(Productivitydir)" || list=; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	done | $(am__base_list) | \
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(Productivitydir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(Productivitydir)" || exit $$?; \
	done
...
uninstall-ProductivityDATA:
	...
	dir='$(DESTDIR)$(Productivitydir)'; $(am__uninstall_files_from_dir)
...
installdirs-am:
	for dir in "$(DESTDIR)$(Productivitydir)" "$(DESTDIR)$(icondir)"; do \
...
install-data-am: install-ProductivityDATA install-iconDATA
...
uninstall-am: uninstall-ProductivityDATA uninstall-iconDATA
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-ProductivityDATA install-am install-data \
	...
	uninstall uninstall-ProductivityDATA uninstall-am \
	uninstall-iconDATA
